...
def max_value(state, alpha, beta, depth):
    ...
    for successorObj in successors:
        ...
        # tempState = State()
        # tempState.matrix = successorObj.nextMatrix
        # tempState.matrix = copy.deepcopy(state.matrix)
        # tempState = apply(tempState, successorObj.rowNum, successorObj.colNum, visited)
        # tempState.matrix = balanceState(successorObj.nextMatrix, successorObj.emptyColumns)
        successorObj.matrix = balanceState(successorObj.nextMatrix, successorObj.emptyColumns)
        # tempState.score = successorObj.regionLength * successorObj.regionLength
        ...
        # result = tempState.score + value
        # result = successorObj.score + value

        if result > v:
            v = result
            row = successorObj.rowNum
            column = successorObj.colNum
            # nextStepMatrix = tempState.matrix
...
def min_value(state, alpha, beta, depth):
    ...
    for successorObj in successors:
        ...
        successorObj.matrix = balanceState(successorObj.nextMatrix, successorObj.emptyColumns)
        # tempState.score = successorObj.regionLength * successorObj.regionLength
        # returnValue = max_value(tempState, alpha, beta, depth)

        # if expandedStates == 1 and return_first_state:
        #     print('Early exit min')
        #     v = -1 * successorObj.score
        #     totalDepth = depth
        #     break
        ...
        # result = returnValue[0] - tempState.score
        # result = returnValue[0] - successorObj.score
...
# print('States Possible : ', states_possible)
